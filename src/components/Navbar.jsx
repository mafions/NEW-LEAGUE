...
export const Navbar = () => {
  return (
    ...
    <nav className='flex items-center justify-center p-4 bg-[#ffffff] gap-5'>
            ...
            <a className=' text-black font-bold  hidden md:inline lg:text-base hover:scale-105' style={{transition: "all 0.3s cubic-bezier(0,0,0.5,1)"}} href="#videos">RESULTADOS</a>
